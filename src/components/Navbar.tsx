    ...
    <>
      ...
      >
        <div className="relative flex items-center justify-between w-full">
          <div className="flex-shrink-0 overflow-hidden h-32">
            <img 
              src="/wzrd.gif"
              alt="WZRD.tech Logo"
              className="h-48 w-auto -mt-8 object-contain transform hover:scale-105 transition-all duration-300 filter drop-shadow-[0_0_8px_rgba(155,135,245,0.6)] hover:drop-shadow-[0_0_12px_rgba(218,165,32,0.8)]"
            />
          </div>
